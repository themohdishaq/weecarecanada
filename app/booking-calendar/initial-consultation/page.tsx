    ...
    <div className="min-h-screen bg-white font-sans">
      ...
      <div className="max-w-5xl mx-auto px-4 sm:px-6 py-8 md:py-12">
        ...
        <div className="flex flex-wrap items-center gap-4 sm:gap-8 bg-purple-50 border border-purple-100 px-5 py-4 mb-8 text-[14px]">
          <span className="font-medium text-[#554971]">Initial Consultation</span>
          <span className="flex items-center gap-1.5 text-gray-600">
            <Clock className="w-3.5 h-3.5 text-[#845f98]" />
            1 hour
          </span>
          <span className="flex items-center gap-1.5 text-[#0fa960] font-medium">
            <DollarSign className="w-3.5 h-3.5" />
            Free
          </span>
        </div>

        {/* Main layout: 3-col on desktop, stacked on mobile */}
          ...
          <div>
            ...
            <div className="bg-gray-50 border border-gray-200 p-5 mb-5 space-y-3">
              <div className="flex justify-between text-[14px]">
                ...
                <span className="text-gray-800 font-medium">Initial Consultation</span>
              </div>
              <div className="flex justify-between text-[14px]">
              ...
              <div className="border-t border-gray-200 pt-3 flex justify-between text-[14px] font-medium">
                <span>Total</span>
                <span className="text-[#0fa960]">Free</span>
              </div>
            </div>
            ...
            <p className="text-[11px] text-gray-400 text-center mt-3 leading-relaxed">
              No payment required. You can reschedule or cancel at any time.
            </p>
          </div>
